...
namespace StartStopTriggerTrace.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class TriggerAlarmRequest : IEquatable<TriggerAlarmRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TriggerAlarmRequest" /> class.
        /// </summary>
        /// <param name="triggerRequestType">TriggerAlarmRequest.</param>
        /// <param name="alarmId">Required/Used for EDA Trace Request.</param>
        /// <param name="state">Required/Used for EDA Trace Request.</param>
        public TriggerAlarmRequest(string triggerRequestType = default(string), decimal? alarmId = default(decimal?), StateEnum? state = default(StateEnum?))
        {
        ...
        /// TriggerAlarmRequest
        /// </summary>
        /// <value>TriggerAlarmRequest</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TriggerAlarmRequest {\n");
        ...
        {
            return this.Equals(input as TriggerAlarmRequest);
        }

        /// <summary>
        /// Returns true if TriggerAlarmRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TriggerAlarmRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TriggerAlarmRequest input)
        {
            if( input == null )
                return false;
