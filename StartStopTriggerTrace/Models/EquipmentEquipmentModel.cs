...
namespace StartStopTriggerTrace.Models
{
    ...
    /// </summary>
    [DataContract]
        public partial class EquipmentEquipmentModel :  IEquatable<EquipmentEquipmentModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EquipmentEquipmentModel" /> class.
        /// </summary>
        /// <param name="id">id (required).</param>
        public EquipmentEquipmentModel(string id = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for EquipmentEquipmentModel and cannot be null");
            }
            else
            {
                this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EquipmentEquipmentModel {\n");
        ...
        {
            return this.Equals(input as EquipmentEquipmentModel);
        }

        /// <summary>
        /// Returns true if EquipmentEquipmentModel instances are equal
        /// </summary>
        /// <param name="input">Instance of EquipmentEquipmentModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EquipmentEquipmentModel input)
        {
            if (input == null)
                return false;
