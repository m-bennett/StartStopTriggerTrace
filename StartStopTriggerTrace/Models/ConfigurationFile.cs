...
namespace StartStopTriggerTrace.Models
{
    ...
    /// </summary>
    [DataContract]
        public partial class ConfigurationFile :  IEquatable<ConfigurationFile>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfigurationFile" /> class.
        /// </summary>
        /// <param name="id">id (required).</param>
        public ConfigurationFile(string id = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for EquipmentModelConfigurationFile and cannot be null");
            }
            else
            {
                this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EquipmentModelConfigurationFile {\n");
        ...
        {
            return this.Equals(input as ConfigurationFile);
        }

        /// <summary>
        /// Returns true if EquipmentModelConfigurationFile instances are equal
        /// </summary>
        /// <param name="input">Instance of EquipmentModelConfigurationFile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConfigurationFile input)
        {
            if (input == null)
                return false;
