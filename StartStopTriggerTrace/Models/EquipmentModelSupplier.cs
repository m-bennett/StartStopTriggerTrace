...
namespace StartStopTriggerTrace.Models
{
    ...
    /// </summary>
    [DataContract]
        public partial class EquipmentModelSupplier :  IEquatable<EquipmentModelSupplier>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EquipmentModelSupplier" /> class.
        /// </summary>
        /// <param name="id">id (required).</param>
        public EquipmentModelSupplier(string id = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for EquipmentModelSupplier and cannot be null");
            }
            else
            {
                this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EquipmentModelSupplier {\n");
        ...
        {
            return this.Equals(input as EquipmentModelSupplier);
        }

        /// <summary>
        /// Returns true if EquipmentModelSupplier instances are equal
        /// </summary>
        /// <param name="input">Instance of EquipmentModelSupplier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EquipmentModelSupplier input)
        {
            if (input == null)
                return false;
