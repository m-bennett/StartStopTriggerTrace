...
namespace StartStopTriggerTrace.Models
{
    ...
    /// </summary>
    [DataContract]
        public partial class EquipmentFactory :  IEquatable<EquipmentFactory>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EquipmentFactory" /> class.
        /// </summary>
        /// <param name="id">id (required).</param>
        public EquipmentFactory(string id = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for EquipmentFactory and cannot be null");
            }
            else
            {
                this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EquipmentFactory {\n");
        ...
        {
            return this.Equals(input as EquipmentFactory);
        }

        /// <summary>
        /// Returns true if EquipmentFactory instances are equal
        /// </summary>
        /// <param name="input">Instance of EquipmentFactory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EquipmentFactory input)
        {
            if (input == null)
                return false;
