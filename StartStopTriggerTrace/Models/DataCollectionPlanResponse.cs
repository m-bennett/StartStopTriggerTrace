...
namespace StartStopTriggerTrace.Models
{
    ...
    /// </summary>
    [DataContract]
        public partial class DataCollectionPlanResponse : Page<DataCollectionPlan>,  IEquatable<DataCollectionPlanResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DataCollectionPlanResponse" /> class.
        /// </summary>
        /// <param name="content">content.</param>
        public DataCollectionPlanResponse(List<DataCollectionPlan> content = default(List<DataCollectionPlan>), PagePageable pageable = default(PagePageable), bool? last = default(bool?), int? totalPages = default(int?), int? totalElements = default(int?), int? size = default(int?), int? number = default(int?), PagePageableSort sort = default(PagePageableSort), int? numberOfElements = default(int?), bool? first = default(bool?), bool? empty = default(bool?)) : base(content, pageable, last, totalPages, totalElements, size, number, sort, numberOfElements, first, empty)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DataCollectionPlanResponse {\n");
        ...
        {
            return this.Equals(input as DataCollectionPlanResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(DataCollectionPlanResponse input)
        {
            if (input == null)
                return false;
