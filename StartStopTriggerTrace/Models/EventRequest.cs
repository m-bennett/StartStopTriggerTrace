...
namespace StartStopTriggerTrace.Models
{
    ...
    /// </summary>
    [DataContract]
        public partial class EventRequest :  Request, IEquatable<EventRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public EventRequest(RequestType requestType = default(RequestType), string eventId = default(string), List<ParameterRequest> parameterRequestsList = default(List<ParameterRequest>))
        {
            // to ensure "requestType" is required (not null)
            if (requestType == RequestType.None)
            {
                throw new InvalidDataException("requestType is a required property for EventRequest and cannot be null");
            }
            else
            {
            ...
            if (eventId == null)
            {
                throw new InvalidDataException("eventId is a required property for EventRequest and cannot be null");
            }
            else
            {
                this.EventId = eventId;
            }
            this.ParameterRequestsList = parameterRequestsList;
        }
