...
namespace StartStopTriggerTrace.Models
{
    ...
    /// </summary>
    [DataContract]
        public partial class OneOfRuleMaximum :  IEquatable<OneOfRuleMaximum>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OneOfRuleMaximum" /> class.
        /// </summary>
        public OneOfRuleMaximum()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OneOfRuleMaximum {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as OneOfRuleMaximum);
        }

        /// <summary>
        /// Returns true if OneOfRuleMaximum instances are equal
        /// </summary>
        /// <param name="input">Instance of OneOfRuleMaximum to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OneOfRuleMaximum input)
        {
            if (input == null)
                return false;
