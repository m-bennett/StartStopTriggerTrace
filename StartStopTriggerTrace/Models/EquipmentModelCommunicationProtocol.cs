...
namespace StartStopTriggerTrace.Models
{
    ...
    /// </summary>
    [DataContract]
        public partial class EquipmentModelCommunicationProtocol :  IEquatable<EquipmentModelCommunicationProtocol>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EquipmentModelCommunicationProtocol" /> class.
        /// </summary>
        /// <param name="id">id (required).</param>
        public EquipmentModelCommunicationProtocol(string id = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for EquipmentModelCommunicationProtocol and cannot be null");
            }
            else
            {
                this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EquipmentModelCommunicationProtocol {\n");
        ...
        {
            return this.Equals(input as EquipmentModelCommunicationProtocol);
        }

        /// <summary>
        /// Returns true if EquipmentModelCommunicationProtocol instances are equal
        /// </summary>
        /// <param name="input">Instance of EquipmentModelCommunicationProtocol to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EquipmentModelCommunicationProtocol input)
        {
            if (input == null)
                return false;
