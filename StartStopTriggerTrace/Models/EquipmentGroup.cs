...
namespace StartStopTriggerTrace.Models
{
    ...
    /// </summary>
    [DataContract]
        public partial class EquipmentGroup :  IEquatable<EquipmentGroup>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EquipmentGroup" /> class.
        /// </summary>
        /// <param name="id">id (required).</param>
        public EquipmentGroup(string id = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for EquipmentGroup and cannot be null");
            }
            else
            {
                this.Id = id;
        ...
        {
            return this.Equals(input as EquipmentGroup);
        }

        /// <summary>
        /// Returns true if EquipmentGroup instances are equal
        /// </summary>
        /// <param name="input">Instance of EquipmentGroup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EquipmentGroup input)
        {
            if (input == null)
                return false;
