...
namespace StartStopTriggerTrace.Models
{
    ...
    /// </summary>
    [DataContract]
        public partial class EquipmentConnectionEquipmentConnectionTemplate :  IEquatable<EquipmentConnectionEquipmentConnectionTemplate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EquipmentConnectionEquipmentConnectionTemplate" /> class.
        /// </summary>
        /// <param name="id">id (required).</param>
        public EquipmentConnectionEquipmentConnectionTemplate(string id = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for EquipmentConnectionEquipmentConnectionTemplate and cannot be null");
            }
            else
            {
                this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EquipmentConnectionEquipmentConnectionTemplate {\n");
        ...
        {
            return this.Equals(input as EquipmentConnectionEquipmentConnectionTemplate);
        }

        /// <summary>
        /// Returns true if EquipmentConnectionEquipmentConnectionTemplate instances are equal
        /// </summary>
        /// <param name="input">Instance of EquipmentConnectionEquipmentConnectionTemplate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EquipmentConnectionEquipmentConnectionTemplate input)
        {
            if (input == null)
                return false;
