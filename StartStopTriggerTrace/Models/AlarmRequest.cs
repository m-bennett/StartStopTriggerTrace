...
namespace StartStopTriggerTrace.Models
{
    ...
    /// </summary>
    [DataContract]
        public partial class AlarmRequest :  Request, IEquatable<AlarmRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlarmRequest" /> class.
        /// </summary>
        /// <param name="requestType">requestType (required).</param>
        /// <param name="alarmId">alarmId (required).</param>
        public AlarmRequest(RequestType requestType = default(RequestType), string alarmId = default(string))
        {
            // to ensure "requestType" is required (not null)
            if (requestType == Models.RequestType.None)
            {
                throw new InvalidDataException("requestType is a required property for AlarmRequest and cannot be 'None'");
            }
            else
            {
                this.RequestType = requestType;
            }
            // to ensure "alarmId" is required (not null)
            if (alarmId == null)
            {
                throw new InvalidDataException("alarmId is a required property for AlarmRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as AlarmRequest);
        }

        /// <summary>
        /// Returns true if AlarmRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AlarmRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlarmRequest input)
        {
            if (input == null)
                return false;
