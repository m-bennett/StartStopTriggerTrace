...
namespace StartStopTriggerTrace.Models
{
	...
	public partial class Rule : IEquatable<Rule>, IValidatableObject
	{
		...
		public Rule(string name = default(string), string description = default(string), TypeEnum? type = default(TypeEnum?), OneOfRuleLimit limit = default(OneOfRuleLimit), OneOfRuleMinimum minimum = default(OneOfRuleMinimum), OneOfRuleMaximum maximum = default(OneOfRuleMaximum))
		{
			this.Name = name;
		...
		public OneOfRuleLimit Limit { get; set; }

		/// <summary>
		/// Gets or Sets Minimum
		/// </summary>
		[DataMember(Name = "minimum", EmitDefaultValue = false)]
		public OneOfRuleMinimum Minimum { get; set; }

		/// <summary>
		/// Gets or Sets Maximum
		/// </summary>
		[DataMember(Name = "maximum", EmitDefaultValue = false)]
		public OneOfRuleMaximum Maximum { get; set; }
