...
namespace StartStopTriggerTrace.Models
{
	...
	/// </summary>
	[DataContract]
	public partial class ConnectorDetails : IEquatable<ConnectorDetails>, IValidatableObject
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="ConnectorDetails" /> class.
		/// </summary>
		/// <param name="name">name (required).</param>
		/// <param name="communicationProtocol">communicationProtocol (required).</param>
		/// <param name="connectorUrl">connectorUrl (required).</param>
		/// <param name="equipmentLimit">equipmentLimit (required).</param>
		public ConnectorDetails(string name = default(string), CommunicationProtocol communicationProtocol = default(CommunicationProtocol), string connectorUrl = default(string), int? equipmentLimit = default(int?))
		{
			Name = name;
		...
		/// <summary>
		/// ID of the created entity, in UUID format
		/// </summary>
		/// <value>ID of the created entity, in UUID format</value>
		...
		/// <summary>
		/// Gets or Sets ConnectorUrl
		/// </summary>
		[DataMember(Name = "connectorUrl", EmitDefaultValue = false)]
		public string ConnectorUrl { get; set; }

		/// <summary>
		/// Gets or Sets EquipmentLimit
		/// </summary>
		[DataMember(Name = "equipmentLimit", EmitDefaultValue = false)]
		public int? EquipmentLimit { get; set; }
		...
		public override string ToString()
		{
			...
			sb.Append("class ConnectorDetails {\n");
			sb.Append("  Id: ").Append(Id).Append("\n");
			sb.Append("  Name: ").Append(Name).Append("\n");
			sb.Append("  CommunicationProtocol: ").Append(CommunicationProtocol).Append("\n");
			sb.Append("  ConnectorUrl: ").Append(ConnectorUrl).Append("\n");
			sb.Append("  EquipmentLimit: ").Append(EquipmentLimit).Append("\n");
		...
		{
			return this.Equals(input as ConnectorDetails);
		}

		/// <summary>
		/// Returns true if ConnectorDetails instances are equal
		/// </summary>
		/// <param name="input">Instance of ConnectorDetails to be compared</param>
		/// <returns>Boolean</returns>
		public bool Equals(ConnectorDetails input)
		{
			if( input == null )
				return false;
			...
			return
				...
				(
					this.ConnectorUrl == input.ConnectorUrl ||
					(this.ConnectorUrl != null &&
					this.ConnectorUrl.Equals(input.ConnectorUrl))
				) &&
				(
					this.EquipmentLimit == input.EquipmentLimit ||
					(this.EquipmentLimit != null &&
					this.EquipmentLimit.Equals(input.EquipmentLimit))
				) &&
				(
		...
		public override int GetHashCode()
		{
			unchecked // Overflow is fine, just wrap
			{
				...
				if( this.ConnectorUrl != null )
					hashCode = hashCode * 59 + this.ConnectorUrl.GetHashCode();
				if( this.EquipmentLimit != null )
					hashCode = hashCode * 59 + this.EquipmentLimit.GetHashCode();
