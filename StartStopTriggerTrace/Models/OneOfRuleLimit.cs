...
namespace StartStopTriggerTrace.Models
{
    ...
    /// </summary>
    [DataContract]
        public partial class OneOfRuleLimit :  IEquatable<OneOfRuleLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OneOfRuleLimit" /> class.
        /// </summary>
        public OneOfRuleLimit()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OneOfRuleLimit {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as OneOfRuleLimit);
        }

        /// <summary>
        /// Returns true if OneOfRuleLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of OneOfRuleLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OneOfRuleLimit input)
        {
            if (input == null)
                return false;
