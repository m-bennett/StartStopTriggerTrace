...
namespace StartStopTriggerTrace.Models
{
        ...
        public partial class CreateResponse :  IEquatable<CreateResponse>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="code">Code which signifies the success response which UI can use to show localized messages.</param>
        /// <param name="message">Default success message.</param>
        public CreateResponse(string code = default(string), string message = default(string))
        {
            this.Code = code;
        ...
        /// <summary>
        /// Code which signifies the success response which UI can use to show localized messages
        /// </summary>
        /// <value>Code which signifies the success response which UI can use to show localized messages</value>
        ...
        /// </summary>
        /// <value>Default success message</value>
