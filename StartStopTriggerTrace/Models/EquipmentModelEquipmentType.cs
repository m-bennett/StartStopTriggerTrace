...
namespace StartStopTriggerTrace.Models
{
    ...
    /// </summary>
    [DataContract]
        public partial class EquipmentModelEquipmentType :  IEquatable<EquipmentModelEquipmentType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EquipmentModelEquipmentType" /> class.
        /// </summary>
        /// <param name="id">id (required).</param>
        public EquipmentModelEquipmentType(string id = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for EquipmentModelEquipmentType and cannot be null");
            }
            else
            {
                this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EquipmentModelEquipmentType {\n");
        ...
        {
            return this.Equals(input as EquipmentModelEquipmentType);
        }

        /// <summary>
        /// Returns true if EquipmentModelEquipmentType instances are equal
        /// </summary>
        /// <param name="input">Instance of EquipmentModelEquipmentType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EquipmentModelEquipmentType input)
        {
            if (input == null)
                return false;
