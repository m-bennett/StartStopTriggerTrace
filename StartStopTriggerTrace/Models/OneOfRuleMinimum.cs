...
namespace StartStopTriggerTrace.Models
{
    ...
    /// </summary>
    [DataContract]
        public partial class OneOfRuleMinimum :  IEquatable<OneOfRuleMinimum>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OneOfRuleMinimum" /> class.
        /// </summary>
        public OneOfRuleMinimum()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OneOfRuleMinimum {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as OneOfRuleMinimum);
        }

        /// <summary>
        /// Returns true if OneOfRuleMinimum instances are equal
        /// </summary>
        /// <param name="input">Instance of OneOfRuleMinimum to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OneOfRuleMinimum input)
        {
            if (input == null)
                return false;
