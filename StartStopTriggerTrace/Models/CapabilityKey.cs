...
namespace StartStopTriggerTrace.Models
{
    ...
    /// </summary>
    [DataContract]
        public partial class CapabilityKey :  IEquatable<CapabilityKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CapabilityKey" /> class.
        /// </summary>
        /// <param name="capabilityName">capabilityName (required).</param>
        public CapabilityKey(string capabilityName = default(string))
        {
            // to ensure "capabilityName" is required (not null)
            if (capabilityName == null)
            {
                throw new InvalidDataException("capabilityName is a required property for CapabilityKey and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets CapabilityName
        /// </summary>
        [DataMember(Name="capabilityName", EmitDefaultValue=false)]
        ...
        {
            return this.Equals(input as CapabilityKey);
        }

        /// <summary>
        /// Returns true if CapabilityKey instances are equal
        /// </summary>
        /// <param name="input">Instance of CapabilityKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CapabilityKey input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.CapabilityName.Equals(input.CapabilityName))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CapabilityName != null)
                    hashCode = hashCode * 59 + this.CapabilityName.GetHashCode();
                return hashCode;
            }
        }
